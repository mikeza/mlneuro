...
__all__ = ['make_multisignal_fn', 'multi_to_single_signal', 'MultisignalScorer', 'MultisignalEstimator',
			'MultisignalSplit', 'cross_val_predict_multisignal', 'train_test_split_multisignal', 
			'GridSearchCVMultisignal', 'RandomizedSearchCVMultisignal']