...
def load_restaurant_row_spikekde():
    """Load an example day of Restaurant Row data from the Redish lab which
    has had KDE run already
    """
...
def load_restaurant_row_time_out(which='rr'):
    ...
    This is a recording session in which both tasks were run in the same day
    """
